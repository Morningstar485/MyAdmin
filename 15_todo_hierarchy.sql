...
ALTER TABLE todos 
ADD COLUMN IF NOT EXISTS parent_task_id UUID REFERENCES todos(id) ON DELETE CASCADE,
ADD COLUMN IF NOT EXISTS position INTEGER DEFAULT 0;

-- 2. Create a helper function to recursively fetch children
...
-- 3. Create the main RPC function requested by the user
